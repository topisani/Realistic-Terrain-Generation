...
public final class RTGWorld {
  ...
  // TODO: On a per world basis
  private RTGBiomeRegistry biomeRegistry = RTGBiomeRegistry.REGISTRY;

  private RTGWorld(World world) {

    this.world = world;
    this.generatorSettings = RTGChunkGenSettings.Factory.jsonToFactory(world.getWorldInfo().getGeneratorOptions().toString()).build();
  ...
  public static void onWorldLoad(WorldEvent.Load event) {
    ...
    if (!world.isRemote) {
      Logger.debug("WorldEvent.Load: WorldType: {}, DimID: {}, DimType: {}, IChunkGenerator: {}",
          world.getWorldType().getClass().getSimpleName(),
          world.getDimension(),
          world.getDimension().getType(),
          world.getChunkProvider().getChunkGenerator().getClass().getName()
      );
  ...
  public static void onWorldUnload(WorldEvent.Unload event) {
    ...
    if (!world.isRemote) {
      Logger.debug("WorldEvent.Unload: WorldType: {}, DimID: {}, DimType: {}, IChunkGenerator: {}",
          world.getWorldType().getClass().getSimpleName(),
          world.getDimension(),
          world.getDimension().getType(),
          world.getChunkProvider().getChunkGenerator().getClass().getName()
  ...
  /**
   * Use this to register RTGBiome versions of biomes.
   */
  public RTGBiomeRegistry getBiomeRegistry() {
