...
public class DecoBoulder extends DecoBase {
    ...
    private IForgeBlockState boulderBlock; // This can be any block.
    ...
    public IForgeBlockState getBoulderBlock() {

        return boulderBlock;
    }

    public DecoBoulder setBoulderBlock(IForgeBlockState boulderBlock) {
