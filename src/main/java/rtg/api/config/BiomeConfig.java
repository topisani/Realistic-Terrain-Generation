    ...
    public BiomeConfig(File file) {
        ...
        DISABLE_RTG_DECORATIONS = new ConfigPropertyBoolean(
            ...
            "If TRUE, RTG decorations will disabled in this biome and only vanilla decorations will generate."
                + NEW_LINE + "RTG decorations include custom trees, shrubs, boulders, etc.",
            false
        );
        ...
        DISABLE_RTG_SURFACES = new ConfigPropertyBoolean(
            ...
            "If TRUE, RTG surfaces will be disabled in this biome and only vanilla surfaces will be used."
                + NEW_LINE + "RTG surfaces include custom top & filler blocks, and 'mix' blocks like podzol in Forests.",
            false
        );
        ...
        SURFACE_CLIFF_STONE_BLOCK = new ConfigPropertyString(
            ...
            "Cliff blocks are the blocks that are used on the cliffs of mountains (usually a blend of stone & cobblestone)."
                + NEW_LINE + "Set this to change this biome's cliff stone block." + BLOCKSTATE_HELP,
            ""
        );
        ...
        SURFACE_CLIFF_COBBLE_BLOCK = new ConfigPropertyString(
            ...
            "Cliff blocks are the blocks that are used on the cliffs of mountains (usually a blend of stone & cobblestone)."
                + NEW_LINE + "Set this to change this biome's cliff cobble block." + BLOCKSTATE_HELP,
            ""
        );
        ...
        BEACH_BIOME = new ConfigPropertyInteger(
            ...
            "Biome ID to use for this biome's beach."
                + NEW_LINE + "The only 'officially supported' values for this setting are:"
                + NEW_LINE + "-1 = Automatic beach generation (RECOMMENDED), 16 = Vanilla Beach, 25 = Vanilla Stone Beach, 26 = Vanilla Cold Beach"
                + NEW_LINE + "The ID of this biome = No beach"
                + NEW_LINE + "Other biome IDs are allowed, but they have not been tested, may yield undesirable results, and will not be supported."
                + NEW_LINE + "Note: If this biome has been hardcoded by RTG to use a specific beach, this setting will have no effect.",
            -1, -1, 255
        );
        ...
        TREE_DENSITY_MULTIPLIER = new ConfigPropertyFloat(
            ...
            "This setting allows you to increase/decrease the number of RTG trees that generate in this biome."
                + NEW_LINE + "This setting overrides the global setting (see /.minecraft/config/RTG/rtg.cfg) and only affects trees generated by RTG."
                + NEW_LINE + "Trees generated by this biome's decorator will adhere to their own density rules."
                + NEW_LINE + "Set to -1.0 to use the global setting."
                + NEW_LINE + "1.0 = Default tree generation; 2.0 = Twice as many trees; 0.5 = half as many trees; 0 = No trees",
            -1.0f, -1.0f, 5.0f
        );
        ...
        SURFACE_WATER_LAKE_MULT = new ConfigPropertyFloat(
                ...
                "This setting allows you to increase/decrease the number of water lakes that generate on the surface of this biome."
                        + NEW_LINE + "1.0 = Default amount; 2.0 = Twice as many water lakes; 0.5 = half as many water lakes; 0 = No water lakes",
                0.4f, 0f, 10.0f
        );
        ...
        SURFACE_LAVA_LAKE_MULT = new ConfigPropertyFloat(
                ...
                "This setting allows you to increase/decrease the number of lava lakes that generate on the surface of this biome."
                        + NEW_LINE + "1.0 = Default amount; 2.0 = Twice as many lava lakes; 0.5 = half as many lava lakes; 0 = No lava lakes",
                0f, 0f, 10.0f
        );
        ...
        FALLEN_LOG_DENSITY_MULTIPLIER = new ConfigPropertyFloat(
            ...
            "This setting allows you to increase/decrease the number of fallen logs that generate in this biome."
                + NEW_LINE + "1.0 = Default density; 2.0 = Twice as many fallen logs; 0.5 = half as many fallen logs; 0 = No fallen logs",
            1f, 0f, 5.0f
        );
