...
public class DesertHillsRTGBiome extends RTGBiomeBase {

    public static Biome biome = Biomes.DESERT_HILLS;
    public static Biome river = Biomes.RIVER;

    public DesertHillsRTGBiome() {
    ...
    public static class SurfaceVanillaDesertHills extends SurfaceBase {
        ...
        public SurfaceVanillaDesertHills(BiomeConfig config, IForgeBlockState top, IForgeBlockState fill, float minCliff) {

            super(config, top, fill);
            min = minCliff;
        }

        public SurfaceVanillaDesertHills(BiomeConfig config, IForgeBlockState top, IForgeBlockState fill, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff) {
        ...
        @Override
        public void paintTerrain(RTGChunkWrapper primer, int i, int j, int x, int z, int depth, RTGWorld rtgWorld, float[] noise, float river, Biome[] base) {
